...
Atlantis.TopNav = [
    {<authcheck:auth authid="400000001">name: "管理首页", index: 10, tid: 4000, logid: 1000, tree: null, url: "#index/"</authcheck:auth>},
    {<authcheck:auth authid="400000002">name: "用户管理", index: 11, tid: 1000, logid: 2000, tree: null, url: "#cust/"</authcheck:auth>},
    {<authcheck:auth authid="400000003">name: "内容管理", index: 12, tid: 1000, logid: 3000, tree: null, url: "#content/"</authcheck:auth>},
    {name: "全部", index: 1, tid: 5000, logid: 300, tree: null, url: "null", target: "_self"},
